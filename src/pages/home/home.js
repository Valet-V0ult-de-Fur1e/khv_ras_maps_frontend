    ...
    <div>
      ...
      >
        ...
        <SidebarTab id="settings" header="Settings" icon="fa fa-cog" anchor="bottom">
          <p><input type="checkbox" defaultChecked={showShapeDataFlag} name="myCheckbox" onClick={()=>{setShowShapeDataFlag(!showShapeDataFlag); console.log(showShapeDataFlag)}}/> Отобразить загруженный файл</p>
        </SidebarTab>
      </Sidebar>
